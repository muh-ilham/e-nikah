...
export default function LaporanPage() {
    ...
    const fetchLaporan = async (selectedYear: string) => {
        setLoading(true);
        try {
            const res = await fetch(`/api/admin/laporan?year=${selectedYear}`);
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 print:hidden">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500 font-medium">Rekapitulasi data pengajuan berbasis tahunan</p>
                    </div>
                </div>
                <div className="flex items-center gap-3">
                ...
                <Card className="border-slate-200/60 shadow-sm overflow-hidden group">
                    ...
                    <CardContent className="p-6 relative">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Total Cerai/Talak {year}</p>
